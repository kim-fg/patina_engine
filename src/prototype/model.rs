...
impl<'a, 'b> DrawModel<'b> for wgpu::RenderPass<'a> where 'b: 'a, {
    fn draw_mesh(
        ...
        self.draw_mesh_instanced(mesh, material, 0..1, camera_bind_group, light_bind_group, environment_bind_group);
    }
    ...
    fn draw_model(
        ...
        self.draw_model_instanced(model, 0..1, camera_bind_group, light_bind_group, environment_bind_group);
    }
    ...
    fn draw_model_instanced_with_material(
        ...
        for mesh in &model.meshes {
            self.draw_mesh_instanced(mesh, material, instances.clone(), camera_bind_group, light_bind_group, environment_bind_group);
        }
    }
}
